        ...
        <div className="py-3 mb-4 back-ground-color" style={{padding:'0 35px'}}>
          ...
          <div>
            <div className="row justify-content-between border-bottom m-0 p-0">
              <div
                className="col-md-2 col-6 p-0 text-bg rounded my-1 text-center"
                style={{ height: "40px" }}
              >
                <h1 className="text-light">Query Form</h1>
              </div>
              <div className="col-md-2 col-6 d-flex justify-content-end align-items-center p-0">
                ...
                <div className="row mt-2 border-bottom pb-4 m-0">
                  <div className="col-12 p-0">
                    <div className="row m-0 p-0">
                      <div className="col-12 p-0">
                        <h6
                          className="head-bg d-inline-block text-white text-center rounded py-1"
                          style={{ width: "150px" }}
                        >
                          Contact Information
                        </h6>
                    ...
                    <div className="row row-gap-4 px-2">
                      {queryInputs.QueryType == "3" && (
                        <div className="col-lg-2 p-0 mx-1">
                          <Field
                            type="text"
                            className="form-input input-bg-color text-dark input-border"
                          ...
                          <Field
                            type="text"
                            className="form-input mt-1 mb-1 input-bg-color text-dark input-border"
                      ...
                      <div className="col-12 col-sm-6 col-lg-3">
                        <div className="row justify-content-between">
                          <div
                            className="col-5 form-input input-bg-color 
                            text-dark input-border 
                          ...
                          <div
                            className="col-5 form-input input-bg-color 
                            text-dark input-border d-flex justify-content-between
                             align-items-center"
                          >
                            <label htmlFor="" className="p-0 m-0">
                              B2B
                          ...
                          <div
                            className="col-5 mt-lg-1 mt-0 form-input 
                            input-bg-color text-dark input-border d-flex 
                      ...
                      <div className="col-12 col-sm-6 col-lg-2 mt-lg-0 mt-1">
                        <div className="row">
                          ...
                          <div className="col-12 p-0 px-lg-1">
                            <Field
                              type="text"
                              className="form-input mt-1 input-bg-color text-dark input-border"
                              placeholder="Subject"
                              name="Subject"
                ...
                {/* query-type and assignment */}

                <div className="row mt-4">
                  <div className="col-sm-6 col-12">
                    {/* Query Type */}
                    <div className="row my-2 pb-3 border-bottom m-0">
                      <div className="row m-0 p-0">
                        <div className="col-12 p-0">
                          <h6
                            className="head-bg d-inline-block text-white pl-2 py-1 rounded"
                            style={{ width: "150px" }}
                          >
                            Query Type
                          </h6>
                      ...
                      <div className="row justify-content-between m-0 p-0">
                        ...
                        <div
                          className="col-lg-3 col-md-6 form-input input-border
                              input-bg-color text-dark d-flex justify-content-between
                              align-items-center "
                        >
                        ...
                        <div
                          className="mt-1 mt-md-0 col-lg-3 col-md-6 form-input
                        input-bg-color input-border text-dark d-flex justify-content-between 
                        align-items-center"
                        >
                          <label htmlFor="" className="m-0 p-0">
                            Fixed Departure
                        ...
                        <div
                          className="mt-1 mt-lg-0 col-lg-3 col-md-6 form-input
                        input-bg-color input-border text-dark d-flex justify-content-between 
                        align-items-center"
                        >
                          <label htmlFor="" className="m-0 p-0">
                      ...
                      <div className="row mt-1 justify-content-between m-0 p-0">
                        <div
                          className="mt-lg-0 col-lg-3 col-md-6 form-input 
                        input-bg-color input-border text-dark d-flex justify-content-between 
                        align-items-center"
                        >
                          <label htmlFor="" className="m-0 p-0">
                        ...
                        <div
                          className="col-lg-3 col-md-6 form-input d-flex 
                        input-bg-color input-border text-dark justify-content-between 
                        align-items-center"
                        >
                          <label htmlFor="" className="m-0 p-0">
                            Multiple Services
                    ...
                    <div className="row justify-content-md-between border-bottom m-0 pb-3">
                      <div className="row m-0 p-0">
                        <div className="col-12 p-0">
                          <h6
                            className="head-bg d-inline-block text-white pl-2 py-1 rounded"
                      ...
                      <div className="col-lg-2 col-md-3 col-4 p-0">
                        ...
                        <div
                          className="pr-2 form-input d-flex 
                        input-bg-color input-border text-dark justify-content-between 
                        align-items-center"
                        >
                          <label htmlFor="" className="p-0 m-0">
                      ...
                      <div className="col-lg-2 col-md-3 col-4 p-0">
                        ...
                        <div
                          className="pr-2 form-input d-flex 
                        input-bg-color input-border text-dark 
                        justify-content-between align-items-center"
                        >
                          <label htmlFor="" className="p-0 m-0">
                            No
                      ...
                      <div className="col-12">
                        <div className="row my-2">
                          <div className="col-12">
                            ...
                            >
                              <div className="accordion-item accordians-background-color">
                                <h2
                                  ...
                                  <div className="accordion-body py-3 px-2">
                                    <div className="row justify-content-between mt-2">
                                      ...
                                      <div className="col-lg-5 col-sm-6 col-5">
                                        ...
                                        <div
                                          className="pr-2 form-input input-bg-color text-dark input-border
                                      ...
                                      <div className="col-lg-5 col-sm-6 col-5 mt-3">
                                        <div
                                          className="pr-2 form-input d-flex justify-content-between
                                        input-bg-color text-dark input-border align-items-center"
                                        >
                                          <label htmlFor="" className="p-0 m-0">
                                            Domestic
                                          </label>
                                    ...
                                    <div className="accordion-body py-3 px-2">
                                      <div className="row align-items-center mt-2">
                                        <div className="col-lg-6 col-md-12 justify-content-between d-flex align-items-center">
                                          ...
                                          <Field
                                            type="text"
                                            className="form-input w-25 input-bg-color text-dark input-border"
                                          ></Field>
                                        </div>
                                      </div>
                        ...
                        <div className="row my-2">
                          <div className="col-12">
                            ...
                            >
                              <div className="accordion-item accordians-background-color">
                                <h2
                                  className="accordion-header accordians-background-color"
                  ...
                  <div className="col-sm-6 col-12">
                    {/* Assignment Column */}
                    <div className="row my-2 pb-3 border-bottom mx-1">
                      <div className="row">
                        <div className="col-12 p-0">
                          <h6
                            className="head-bg d-inline-block text-white pl-2 py-1 rounded"
                                ...
                                >
                                  <div className="accordion-body py-3 px-2">
                                    ...
                                    <div className="row justify-content-between m-0">
                                      <div
                                        className="col-md-3 col-4 form-input d-flex 
                                      input-bg-color text-dark input-border justify-content-between 
                                      align-items-center"
                                      >
                                        <label htmlFor="" className="m-0 p-0">
                                          Normal
                                    ...
                                    <div className="row justify-content-between m-0">
                                      <div
                                        className="col-md-3 col-4 form-input d-flex 
                                      input-bg-color text-dark input-border 
                                      justify-content-between align-items-center"
                                      >
                                        <label htmlFor="" className="m-0 p-0">
                                          24 Hours
                                    ...
                                    <div className="row justify-content-between m-0">
                                      <div
                                        className="col-lg-5 col-6 form-input d-flex 
                                      input-bg-color text-dark input-border 
                                      justify-content-between align-items-center"
                                      >
                                        <label htmlFor="" className="m-0 p-0">
                                      ...
                                      <div
                                        className="col-lg-5 col-6 mt-2 form-input d-flex 
                                      input-bg-color text-dark input-border 
                                      justify-content-between align-items-center"
                                      >
                                        <label htmlFor="" className="m-0 p-0">
                                    ...
                                    <div className="row justify-content-between m-0">
                                      <div className="col-lg-5 col-6 mt-2 p-0">
                                        <span className="text-danger m-0 p-0">
                    ...
                    <div className="row">
                      <div className="col-12">
                        <div className="card shadow-none border">
                          ...
                          <div className="card-body px-2 accordians-background-color">
                            <div className="my-2">Hotel Category</div>
                            <div className="row justify-content-between m-0">
                              <div
                                className="col-md-2 col-6 form-input d-flex 
                              input-bg-color text-dark input-border 
                              justify-content-between align-items-center m-0"
                              >
