								...
								<div className="header-elements">
									<div className="form-check form-check-right form-check-switchery form-check-switchery-sm">
										<label className="form-check-label">
											Live update:
											<input type="checkbox" className="form-input-switchery" checked data-fouc/>
										</label>
									</div>
								</div>
							</div>
							...
							<div className="card-body py-0">
								<div className="row">
									...
									<div className="col-sm-4">
										...
										<div className="w-75 mx-auto mb-3" id="new-sessions"></div>
									</div>
									...
									<div className="col-sm-4">
										...
										<div className="w-75 mx-auto mb-3" id="total-online"></div>
									</div>
								</div>
							</div>

							<div className="chart position-relative" id="traffic-sources"></div>
						</div>
						{/* /traffic sources */}
								...
								<div className="header-elements">
									...
									<div className="list-icons ml-3">
				                		<div className="list-icons-item dropdown">
				                			<a href="#" className="list-icons-item dropdown-toggle" data-toggle="dropdown"><i className="icon-menu7"></i></a>
									...
									<div className="card-body">
										<div className="d-flex">
											...
											<div className="list-icons ml-auto">
						                		<div className="list-icons-item dropdown">
						                			<a href="#" className="list-icons-item dropdown-toggle" data-toggle="dropdown"><i className="icon-cog3"></i></a>
													<div className="dropdown-menu dropdown-menu-right">
														<a href="#" className="dropdown-item"><i className="icon-sync"></i> Update data</a>
														<a href="#" className="dropdown-item"><i className="icon-list-unordered"></i> Detailed log</a>
														<a href="#" className="dropdown-item"><i className="icon-pie5"></i> Statistics</a>
						...
						<div className="card">
							...
							<div className="card-body d-md-flex align-items-md-center justify-content-md-between flex-md-wrap">
								<div className="d-flex align-items-center mb-3 mb-md-0">
									...
									<div className="ml-3">
										<h5 className="font-weight-semibold mb-0">14,327 <span className="text-success font-size-sm font-weight-normal"><i className="icon-arrow-up12"></i> (+2.9%)</span></h5>
									...
									<tbody>
										...
										<tr>
											...
											<td className="text-center">
												<div className="list-icons">
													<div className="list-icons-item dropdown">
														<a href="#" className="list-icons-item dropdown-toggle caret-0" data-toggle="dropdown"><i classNameName="icon-menu7"></i></a>
														<div className="dropdown-menu dropdown-menu-right">
															...
															<div className="dropdown-divider"></div>
															<a href="#" className="dropdown-item"><i className="icon-checkmark3 text-success"></i> Resolve issue</a>
										...
										<div className="media flex-column flex-sm-row mt-0 mb-3">
				        					<div className="mr-sm-3 mb-2 mb-sm-0">
												<div className="card-img-actions">
													<a href="#">
														<img src="../../../../global_assets/images/placeholders/placeholder.jpg" className="img-fluid img-preview rounded" alt=""/>
											...
											<td>
												<div className="d-flex align-items-center">
													...
													<div>
														...
														<div className="text-muted font-size-sm"><i className="icon-checkmark3 font-size-sm mr-1"></i> New order</div>
													</div>
												</div>
											</td>
											<td>
											...
											<td>
												<div className="d-flex align-items-center">
													...
													<div>
														...
														<div className="text-muted font-size-sm"><i className="icon-spinner11 font-size-sm mr-1"></i> Renewal</div>
													</div>
												</div>
											</td>
											<td>
											...
											<td>
												<div className="d-flex align-items-center">
													...
													<div>
														...
														<div className="text-muted font-size-sm"><i className="icon-lifebuoy font-size-sm mr-1"></i> Support</div>
													</div>
												</div>
											</td>
											<td>
										...
										<tr>
											<td>
												<div className="d-flex align-items-center">
													...
													<div>
														<a href="#" className="text-default font-weight-semibold letter-icon-title">Alpha application</a>
														<div className="text-muted font-size-sm"><i className="icon-spinner11 font-size-sm mr-2"></i> Renewal</div>
													</div>
												</div>
											</td>
											<td>
							...
							<div className="card-header header-elements-inline">
								...
								<div className="header-elements">
									<div className="form-check form-check-inline form-check-right form-check-switchery form-check-switchery-sm">
										<label className="form-check-label">
											<input type="checkbox" className="form-input-switchery" id="realtime" checked data-fouc/>
											Realtime
										</label>
									</div>
