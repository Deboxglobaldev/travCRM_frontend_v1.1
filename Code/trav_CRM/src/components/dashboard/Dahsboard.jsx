            ...
            <div className="row">
              ...
              <div className="col-5">
                ...
                <div className="card">
                  ...
                  <div className="chart mb-2" id="app_sales"></div>
                  <div className="chart" id="monthly-sales-stats"></div>
                </div>
                {/* /sales stats */}
              </div>
            </div>
                        ...
                        <div className="list-icons-item dropdown">
                          ...
                          <div className="dropdown-menu">
                            <a href="#" className="dropdown-item">
                              <i className="icon-sync"></i> Update data
                            </a>
                            <a href="#" className="dropdown-item">
                              <i className="icon-list-unordered"></i> Detailed
                              log
                            </a>
                            <a href="#" className="dropdown-item">
                              <i className="icon-pie5"></i> Statistics
                            </a>
                            <div className="dropdown-divider"></div>
                            <a href="#" className="dropdown-item">
                              <i className="icon-cross3"></i> Clear list
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
                      ...
                      <div className="ml-3">
                        <h5 className="font-weight-semibold mb-0">
                          ...
                          <span className="text-success font-size-sm font-weight-normal">
                            <i className="icon-arrow-up12"></i> (+16.2%)
                          </span>
                        </h5>
                      ...
                      <div className="ml-3">
                        <h5 className="font-weight-semibold mb-0">
                          ...
                          <span className="text-danger font-size-sm font-weight-normal">
                            <i className="icon-arrow-down12"></i> (-4.9%)
                          </span>
                        </h5>
                    ...
                    <div>
                      <a href="#" className="btn bg-indigo-300">
                        <i className="icon-statistics mr-2"></i> View report
                      </a>
                    </div>
                  </div>
                    ...
                    <table className="table text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <span className="text-success-600">
                              <i className="icon-stats-growth2 mr-2"></i> 2.43%
                            </span>
                          </td>
                          <td>
                            ...
                            <div className="list-icons">
                              <div className="list-icons-item dropdown">
                                ...
                                <div className="dropdown-menu dropdown-menu-right">
                                  <a href="#" className="dropdown-item">
                                    <i className="icon-file-stats"></i> View
                                    statement
                                  </a>
                                  <a href="#" className="dropdown-item">
                                    <i className="icon-file-text2"></i> Edit
                                    campaign
                                  </a>
                                  <a href="#" className="dropdown-item">
                                    <i className="icon-file-locked"></i> Disable
                                    campaign
                                  </a>
                                  <div className="dropdown-divider"></div>
                                  <a href="#" className="dropdown-item">
                        ...
                        <tr>
                          <td>
                            <div className="d-flex align-items-center">
                              <div className="mr-3">
                                <a href="#">
                                  <img
                                    src="../../../../global_assets/images/brands/youtube.png"
                                    className="rounded-circle"
                                    width="32"
                                    height="32"
                                    alt=""
                          ...
                          <td>
                            <span className="text-success-600">
                              <i className="icon-stats-growth2 mr-2"></i> 3.12%
                            </span>
                          </td>
                          <td>
                            <h6 className="font-weight-semibold mb-0">
                        ...
                        <tr>
                          <td>
                            <div className="d-flex align-items-center">
                              <div className="mr-3">
                                <a href="#">
                                  <img
                                    src="../../../../global_assets/images/brands/spotify.png"
                                    className="rounded-circle"
                                    width="32"
                                    height="32"
                                    alt=""
                          ...
                          <td>
                            <span className="text-danger">
                              <i className="icon-stats-decline2 mr-2"></i> -
                              8.02%
                            </span>
                          </td>
                          <td>
                          ...
                          <td>
                            <span className="badge bg-grey-400">On hold</span>
                          </td>
                          <td className="text-center">
                            <div className="list-icons">
                              <div className="list-icons-item dropdown">
                        ...
                        <tr>
                          <td>
                            <div className="d-flex align-items-center">
                              <div className="mr-3">
                                <a href="#">
                                  <img
                                    src="../../../../global_assets/images/brands/twitter.png"
                                    className="rounded-circle"
                                    width="32"
                                    height="32"
                                    alt=""
                          ...
                          <td>
                            <span className="text-success-600">
                              <i className="icon-stats-growth2 mr-2"></i> 2.78%
                            </span>
                          </td>
                          <td>
                            <h6 className="font-weight-semibold mb-0">
                        ...
                        <tr>
                          ...
                          <td>
                            <h6 className="font-weight-semibold mb-0">$970</h6>
                          </td>
                          <td>
                            <span className="badge bg-success-400">
                              Pending
                            </span>
                          </td>
                          <td className="text-center">
                        ...
                        <tr>
                          <td>
                            <div className="d-flex align-items-center">
                              <div className="mr-3">
                                <a href="#">
                                  <img
                                    src="../../../../global_assets/images/brands/amazon.png"
                                    className="rounded-circle"
                                    width="32"
                                    height="32"
                                    alt=""
                          ...
                          <td>
                            <span className="text-success-600">
                              <i className="icon-stats-growth2 mr-2"></i> 6.79%
                            </span>
                          </td>
                          <td>
                            <h6 className="font-weight-semibold mb-0">
                        ...
                        <tr>
                          <td>
                            <div className="d-flex align-items-center">
                              <div className="mr-3">
                                <a href="#">
                                  <img
                                    src="../../../../global_assets/images/brands/dribbble.png"
                                    className="rounded-circle"
                                    width="32"
                                    height="32"
                                    alt=""
                          ...
                          <td>
                            <span className="text-danger">
                              <i className="icon-stats-decline2 mr-2"></i> 9.83%
                            </span>
                          </td>
                          <td>
                            <h6 className="font-weight-semibold mb-0">
                    ...
                    <div className="card bg-teal-400">
                      <div className="card-body">
                        <div className="d-flex">
                          ...
                          <span className="badge bg-teal-800 badge-pill align-self-center ml-auto">
                            +53,6%
                          </span>
                        </div>
                  ...
                  <div className="card-body d-md-flex align-items-md-center justify-content-md-between flex-md-wrap">
                    <div className="d-flex align-items-center mb-3 mb-md-0">
                      ...
                      <div className="ml-3">
                        <h5 className="font-weight-semibold mb-0">
                          14,327{" "}
                          <span className="text-success font-size-sm font-weight-normal">
                            <i className="icon-arrow-up12"></i> (+2.9%)
                          </span>
                        </h5>
                        <span className="badge badge-mark border-success mr-1"></span>{" "}
                    ...
                    <div>
                      <a href="#" className="btn bg-teal-400">
                        <i className="icon-statistics mr-2"></i> Report
                      </a>
                    </div>
                  </div>
                            ...
                            <div className="list-icons">
                              <div className="list-icons-item dropdown">
                                <a
                                  ...
                                  data-toggle="dropdown"
                                >
                                  <i classNameName="icon-menu7"></i>
                                </a>
                                <div className="dropdown-menu dropdown-menu-right">
                                  <a href="#" className="dropdown-item">
                                    <i className="icon-undo"></i> Quick reply
                                  </a>
                                  <a href="#" className="dropdown-item">
                                    <i className="icon-history"></i> Full
                                    history
                                  </a>
                                  <div className="dropdown-divider"></div>
                                  <a href="#" className="dropdown-item">
                            ...
                            <div className="list-icons">
                              <div className="list-icons-item dropdown">
                                ...
                                <div className="dropdown-menu dropdown-menu-right">
                                  ...
                                  <div className="dropdown-divider"></div>
                                  <a href="#" className="dropdown-item">
                                    <i className="icon-plus3 text-blue"></i>{" "}
                                    Unresolve issue
                                  </a>
                                  <a href="#" className="dropdown-item">
                                    <i className="icon-cross2 text-danger"></i>{" "}
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="#" className="text-default">
                              ...
                              <span className="text-muted">
                                Fix behavior when using tooltips and popovers
                                that are...
                              </span>
                            </a>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="#" className="text-default">
                              ...
                              <span className="text-muted">
                                Resizes control label's font-size and account
                                for the standard...
                              </span>
                            </a>
                          </td>
                            ...
                            <div className="list-icons">
                              <div className="list-icons-item dropdown">
                                ...
                                <div className="dropdown-menu dropdown-menu-right">
                                  ...
                                  <a href="#" className="dropdown-item">
                                    <i className="icon-spinner11 text-grey"></i>{" "}
                                    Reopen issue
                                  </a>
                                </div>
                              </div>
                            ...
                            <div className="card-img-actions">
                              <a href="#">
                                ...
                                <span className="card-img-actions-overlay card-img">
                                  <i className="icon-play3 icon-2x"></i>
                                </span>
                              </a>
                            </div>
                          </div>
                          ...
                          <div className="media-body">
                            ...
                            <ul className="list-inline list-inline-dotted text-muted mb-2">
                              <li className="list-inline-item">
                                <i className="icon-book-play mr-2"></i> Video
                                tutorials
                              </li>
                            </ul>
                      ...
                      <div className="col-xl-6">
                        ...
                        <div className="media flex-column flex-sm-row mt-0 mb-3">
                          ...
                          <div className="media-body">
                            ...
                            <ul className="list-inline list-inline-dotted text-muted mb-2">
                              <li className="list-inline-item">
                                <i className="icon-book-play mr-2"></i> FAQ
                                section
                              </li>
                            </ul>
              ...
              <div className="col-4">
                ...
                <div className="card">
                  <div className="card-header header-elements-inline">
                    ...
                    <div className="header-elements">
                      <span className="font-weight-bold text-danger-600 ml-2">
                        $4,378
                      </span>
                      <div className="list-icons ml-3">
                        <div className="list-icons-item dropdown">
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                ...
                                <div className="text-muted font-size-sm">
                                  <i className="icon-spinner11 font-size-sm mr-1"></i>{" "}
                                  Renewal
                                </div>
                              </div>
                            </div>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                ...
                                <div className="text-muted font-size-sm">
                                  <i className="icon-lifebuoy font-size-sm mr-1"></i>{" "}
                                  Support
                                </div>
                              </div>
                            </div>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                ...
                                <div className="text-muted font-size-sm">
                                  <i className="icon-spinner11 font-size-sm mr-2"></i>{" "}
                                  Renewal
                                </div>
                              </div>
                            </div>
                ...
                <div className="card">
                  <div className="card-header header-elements-inline">
                    ...
                    <div className="header-elements">
                      <span>
                        <i className="icon-history text-warning mr-2"></i> Jul
                        7, 10:30
                      </span>
                      <span className="badge bg-success align-self-start ml-3">
                        Online
                      </span>
                    </div>
                  </div>
                  ...
                  <ul className="nav nav-tabs nav-tabs-solid nav-justified bg-indigo-400 border-x-0 border-bottom-0 border-top-indigo-300 mb-0">
                    <li className="nav-item">
                      <a
                        href="#messages-tue"
                        className="nav-link font-size-sm text-uppercase active"
                        data-toggle="tab"
                      >
                        Tuesday
                      </a>
                    ...
                    <li className="nav-item">
                      <a
                        href="#messages-mon"
                        className="nav-link font-size-sm text-uppercase"
                        data-toggle="tab"
                      >
                        Monday
                      </a>
                        ...
                        <li className="media">
                          <div className="mr-3 position-relative">
                            <img
                              ...
                              alt=""
                            />
                            <span className="badge bg-danger-400 badge-pill badge-float border-2 border-white">
                              8
                            </span>
                          </div>
                ...
                <div className="card">
                  <div className="card-header header-elements-inline">
                    ...
                    <div className="header-elements">
                      ...
                      <span className="badge bg-danger-400 badge-pill">
                        +86
                      </span>
                    </div>
                  </div>
                    ...
                    <ul className="media-list">
                      <li className="media">
                        <div className="mr-3">
                          <a
                            href="#"
                            className="btn bg-transparent border-pink text-pink rounded-round border-2 btn-icon"
                          >
                        ...
                        <div className="media-body">
                          Stats for July, 6:{" "}
                          <span className="font-weight-semibold">1938</span>{" "}
                          orders,{" "}
                      ...
                      <li className="media">
                        <div className="mr-3">
                          ...
                          >
                            <i className="icon-alignment-unalign"></i>
                          </a>
                        </div>
                      ...
                      <li className="media">
                        <div className="mr-3">
                          <a
                            href="#"
                            className="btn bg-transparent border-warning-400 text-warning-400 rounded-round border-2 btn-icon"
                          >
                            <i className="icon-spinner11"></i>
                          </a>
                        </div>
                      ...
                      <li className="media">
                        <div className="mr-3">
                          <a
                            href="#"
                            className="btn bg-transparent border-teal text-teal rounded-round border-2 btn-icon"
                          >
